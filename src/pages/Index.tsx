  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-hero py-24 px-6">
        ...
        <div className="container mx-auto text-center text-white relative z-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[200px] bg-gradient-radial from-white/30 via-white/10 to-transparent rounded-full blur-3xl animate-pulse-glow pointer-events-none" />
